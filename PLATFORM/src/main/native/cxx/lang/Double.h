 ...
 */
#ifndef CXX_LANG_DOUBLE_H_
#define CXX_LANG_DOUBLE_H_
...
class Double : public Comparable {
	...
	public:
		...
		virtual boolean equals(const Object* obj) const {
			return obj != null && m_value == ((Double*) obj)->m_value;
		}

		virtual int compareTo(const Object* obj) const {
			return (m_value < ((Double*) obj)->m_value ? -1 : (m_value == ((Double*) obj)->m_value ? 0 : 1));
		}
};

} } // namespace

#endif /*CXX_LANG_DOUBLE_H_*/
